                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="text-center">
                                            <img alt="Charles Hall" src="https://demo.adminkit.io/img/avatars/avatar.jpg" class="rounded-circle img-responsive mt-2" width="128" height="128">
                                            <div class="mt-2">
